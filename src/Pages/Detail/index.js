...
export default function Detail() {
  ...
  const message = `Olá ${
    incident.nome
  }, entro em contato pois gostaria de ajudar no caso "${incident.titulo}" com o valor de ${Intl.NumberFormat("pt-BR", {style: "currency", currency: "BRL"}).format(incident.valor)}`;
  ...
  function sendMail() {
    MailComposer.composeAsync({
      subject: `Heroi Caso: ${incident.titulo}`,
